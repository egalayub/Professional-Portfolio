...
import CryptoPedia from '../assets/CryptoPedia.jpg';
const Projects = () => {
  return (
...
<div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
     {/* Grid Item */}
     <div style={{backgroundImage: `url(${CryptoPedia})`}}
    className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
        ...
        CryptoPedia
            ...
            <div className='pt-8 text-center'>
                ...
                <div>
                    <a href="https://github.com/egalayub/Investing-App"target="_blank" rel="noreferrer">
    ...
    className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
        ...
        Meals By Dads
            ...
            <div className='pt-8 text-center'>
                ...
                <div>
                    <a href="https://github.com/egalayub/MealsByDad"target="_blank" rel="noreferrer">
                        <button className='text-center rounded-lg px-4 py-3 my-2 bg-white text-gray-700 font-bold text-lg'>Code</button>
                    </a>
                </div>
